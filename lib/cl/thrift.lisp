...
(defgeneric treadall (tr len)
  (:method ((tr ttransport) len)
...
(defgeneric write-struct-begin (prot name)
  (:method ((prot protocol) name)))
(defgeneric write-struct-end (prot)
  (:method ((prot protocol))))
(defgeneric write-field-begin (prot name type id))
(defgeneric write-field-end (prot)
  (:method ((prot protocol))))
(defgeneric write-field-stop (prot))
(defgeneric write-map-begin (prot ktype vtype size))
(defgeneric write-map-end (prot))
(defgeneric write-list-begin (prot etype size))
(defgeneric write-list-end (prot))
(defgeneric write-set-begin (prot etype size))
(defgeneric write-set-end (prot))
(defgeneric write-bool (prot val))
(defgeneric write-byte (prot val))
(defgeneric write-i16 (prot val))
(defgeneric write-i32 (prot val))
(defgeneric write-i64 (prot val))
(defgeneric write-u16 (prot val))
(defgeneric write-u32 (prot val))
(defgeneric write-double (prot val))
(defgeneric write-string (prot val))
(defgeneric read-message-begin (prot))
(defgeneric read-message-end (prot))
(defgeneric read-struct-begin (prot))
(defgeneric read-struct-end (prot))
(defgeneric read-field-begin (prot))
(defgeneric read-field-end (prot))
(defgeneric read-map-begin (prot))
(defgeneric read-map-end (prot))
(defgeneric read-list-begin (prot))
(defgeneric read-list-end (prot))
(defgeneric read-set-begin (prot))
(defgeneric read-set-end (prot))
(defgeneric read-byte (prot))
(defgeneric read-i16 (prot))
(defgeneric read-i32 (prot))
(defgeneric read-i64 (prot))
(defgeneric read-double (prot))
(defgeneric read-bool (prot))
(defgeneric read-string (prot))
(defgeneric read-value (prot type))
...
(defun gen-send-method (svc fn params tret async exceptions)
  (let ((names (strs-syms params :key #'car)))
    (with-gensyms (gsvc gprot)
      `(progn
	 (defgeneric ,(str-sym fn) (,gsvc ,@names))
...
(defgeneric server-itrans (server client))
(defgeneric server-otrans (server client))
(defgeneric server-iprot (server transport))
(defgeneric server-oprot (server transport))
(defgeneric server-close (server))
(defgeneric serve (server client &optional handler))
